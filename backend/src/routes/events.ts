...
// In test environments, log available prisma properties to help debug mocked modules
if (process.env.NODE_ENV === 'test') {
  try {
    console.log('TEST PRISMA KEYS:', Object.keys((prisma as any) ?? {}));
  } catch (err) {
    console.error('Failed listing prisma keys for debug:', err);
  }
}
