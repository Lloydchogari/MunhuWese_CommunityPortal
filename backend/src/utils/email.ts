...
async function sendMailOptions(opts: { to: string; subject: string; text: string; html?: string }) {
...
export async function sendEventRegistrationEmail(to: string, eventTitle: string) {
